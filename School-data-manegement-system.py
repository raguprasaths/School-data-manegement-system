...
main = Tk()
main.title('School Data Management System')
...
Label(main, text="SCHOOL Data Management", font=headlabelfont, bg='#6CE0F3').pack(side=TOP, fill=X)
left_frame = Frame(main, bg='#97EAF7')
left_frame.place(x=0, y=30, relheight=1, relwidth=0.2)
center_frame = Frame(main, bg='#97EAF7')
center_frame.place(relx=0.2, y=30, relheight=1, relwidth=0.2)
right_frame = Frame(main, bg="Gray35")
right_frame.place(relx=0.4, y=30, relheight=1, relwidth=0.6)

# Placing components in the left frame
Label(left_frame, text="Name", font=labelfont, bg='#97EAF7').place(relx=0.1, rely=0.05)
Label(left_frame, text="Contact Number", font=labelfont, bg='#97EAF7').place(relx=0.1, rely=0.18)
Label(left_frame, text="Email Address", font=labelfont, bg='#97EAF7').place(relx=0.1, rely=0.31)
Label(left_frame, text="Gender", font=labelfont, bg='#97EAF7').place(relx=0.1, rely=0.44)
Label(left_frame, text="Date of Birth (DOB)", font=labelfont, bg='#97EAF7').place(relx=0.1, rely=0.57)
Label(left_frame, text="Class", font=labelfont, bg='#97EAF7').place(relx=0.1, rely=0.7)
...
OptionMenu(left_frame, gender_strvar, 'Male', "Female").place(x=20, rely=0.49, relwidth=0.59)
